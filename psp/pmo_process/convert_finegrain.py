...
def convert_mh2_pmo(pmo, mtl_file, dirname, basename, second=None, verbose=False, enforce_ge_verbose=False):
    ...
    # ! Fine-grain: set to a very large i
    # This will produce many triangle strips (they form the model(s))
    # Use this when the normal convert script fails to split the mesh properly
    for i in range(3000):
